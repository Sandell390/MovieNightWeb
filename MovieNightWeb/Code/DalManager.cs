    ...
    public static class DalManager
    {
        ...
        public static List<Film> GetFilms()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cs))
            {
                ...
                SqlCommand cmd = new SqlCommand("select movie.id as [movie_id], movie.title,movie.year, genre.name, genre.id as [genre_id] from genre_movie " +
                    "left join movie  " +
                ...
                while (rdr.Read())
                {
                    ...
                    else
                    {
                        ...
                        Film f = new Film(id, title, year, genreList);
        ...
        public static List<Actor> GetActorsFromSearch(string searchMessage)
        {
            ...
            using (SqlConnection connection = new SqlConnection(cs))
            {
                ...
                SqlCommand cmd = new SqlCommand("select id, firstname, lastname from actor where firstname like @search", connection);
        ...
        public static List<Genre> GetGenre() 
        {
            ...
            using (SqlConnection connection = new SqlConnection(cs))
            {
                ...
                SqlCommand cmd = new SqlCommand("select id,name from genre", connection);
