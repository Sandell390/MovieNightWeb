...
namespace Movies
{
    public static class FilmManager
    {
        ...
        {
            List<Film> MovieName = new List<Film>();
        ...
        public static async Task<string> GetThumbNailAsync(string name) 
        {
            string picAdress = "";
            ...
            try
            {
                ...
                HttpResponseMessage response = await client.GetAsync($"http://www.omdbapi.com/?t={name}&apikey=272d0783");
            ...
            {
                picAdress = "ERROR: Can not get pic";
            }
